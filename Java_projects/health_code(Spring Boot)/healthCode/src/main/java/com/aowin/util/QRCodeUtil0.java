...
public class QRCodeUtil0 {
    ...
    public static BufferedImage createImage(String content, String logoPath, boolean needCompress) throws Exception {
        ...
        // 插入图片
        QRCodeUtil0.insertImage(image, logoPath, needCompress);
        return image;
    }
    ...
    private static void insertImage(BufferedImage source, String logoPath, boolean needCompress) throws IOException {
        ...
        try {
            inputStream = QRCodeUtil0.getResourceAsStream(logoPath);
    ...
    public static void encode(String content, String logoPath, OutputStream output, boolean needCompress)
            throws Exception {
        BufferedImage image = QRCodeUtil0.createImage(content, logoPath, needCompress);
    ...
    public static InputStream getResourceAsStream(String logoPath) {
        return QRCodeUtil0.class.getResourceAsStream(logoPath);
    }
}